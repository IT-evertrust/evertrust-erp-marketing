...
# Dev CORS: lets the local mock control panel (an HTML page opened from disk, origin
# "null", or any localhost port) POST to this service directly from the browser.
