...
export function GrowthTopbar() {
  ...
  return (
    <header className="sticky top-0 z-10 flex items-center gap-4 border-b border-border bg-background/80 px-6 py-[18px] backdrop-blur supports-[backdrop-filter]:bg-background/60">
