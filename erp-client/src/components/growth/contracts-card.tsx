...
// Reusable read-only contract list scoped to a campaign (campaign detail › Contracts
// tab). The fetch only fires when a campaign scope is set.
export function ContractsCard({
  ...
  const enabled = !!filters.campaignId;
