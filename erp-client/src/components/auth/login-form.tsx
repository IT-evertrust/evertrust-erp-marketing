...
// The brand mark mirrors the in-app sidebar lockup (emerald Crosshair) so login and
// shell read as one product.
    ...
    <Card className="w-full max-w-sm border-border/60 bg-card/80 shadow-2xl shadow-black/30 backdrop-blur">
      <CardContent className="flex flex-col gap-8 px-8 py-10">
        <div className="flex flex-col items-center gap-4 text-center">
          <span className="flex size-12 items-center justify-center rounded-2xl bg-primary/10 text-primary ring-1 ring-inset ring-primary/20">
