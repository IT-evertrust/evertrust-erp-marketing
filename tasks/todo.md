...
- [ ] **USER: teardown** (everything verified green): suspend/delete Render `evertrust-api` service + `evertrust-db` database, delete the Vercel project, archive `Ryugwki/evertrust-ERP` on GitHub with a README pointer to evertrust-gmbh/evertrust-erp-marketing.
