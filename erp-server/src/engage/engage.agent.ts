...
// Synchronous client for the erp-agents service used by Engage (reply_glock +
// rag_agent). POSTs a job to `${AGENTS_BASE_URL}/run` and returns the AgentResult in
// the same request. Mirrors ReachAgentClient — kept local to the engage module.
@Injectable()
